...
class ObjectDetector:
    def __init__(self, model_path):
        if not HAS_TENSORFLOW:
            print("\n" + "="*75)
            print("[ERROR] TensorFlow is not installed in your current environment.")
            print("To run the legacy 'seat_detection.py' script, please install it:")
            print("    pip install tensorflow")
            print("\nAlternatively, run the optimized, TensorFlow-free version built for Pi 5:")
            print("    python SSOS/app.py")
            print("="*75 + "\n")
            raise ImportError("TensorFlow is required for the legacy ObjectDetector.")
